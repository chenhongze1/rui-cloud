...
public class MonitoringProperties {
    ...
    public static class MetricsConfig {
        ...
        public boolean isJvmEnabled() {
            return enabled && enabledMetrics.contains("jvm");
        }

        public boolean isSystemEnabled() {
            return enabled && enabledMetrics.contains("system");
        }
    ...
    public static class PerformanceConfig {
        ...
        public boolean isSlowOperationEnabled() {
            return enabled && slowOperation.isEnabled();
        }

        public boolean isResourceUsageEnabled() {
            return enabled && resourceUsage.isEnabled();
        }
